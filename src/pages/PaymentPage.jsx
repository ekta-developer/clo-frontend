...
const PaymentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f7f4ef] px-4 md:px-10 lg:px-20 py-10 text-[#1a1a1a]">
      {/* Header */}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 lg:gap-16">
        {/* Payment Form */}
        <div>
          <h2 className="text-3xl font-serif mb-10">Payment</h2>
          ...
          <form className="space-y-7" onSubmit={handlePlaceOrder}>
            ...
            <button
              ...
              className="text-sm uppercase tracking-[2px] text-[#5d5550] hover:text-black transition"
            >
              ← Back To Shipping
            </button>
        ...
        <div className="bg-[#f3eee7] p-6 md:p-8 h-fit">
          ...
          <div className="py-6 border-b border-[#d8d1c8]">
            ...
            <div className="flex">
              ...
              <button className="bg-black hover:bg-[#222] transition px-5 text-white uppercase tracking-[2px] text-xs">
                Apply
              </button>
            </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full border border-[#d5cfc7] bg-transparent h-14 px-4 outline-none focus:border-black transition"
      />
    </div>
  );
};
